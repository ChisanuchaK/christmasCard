...
import { getDocs , query , collection , where , doc , deleteDoc  , updateDoc , onSnapshot , getCountFromServer } from '@firebase/firestore';
...
const snapshot = await getCountFromServer(query_);
   total.value = snapshot.data().count;
}
...
<template>
        <div class="card-myFeed">
            <h1 class="title-mfd">Feed total card : {{totalCom}}</h1>
